...
$string['correctfeedback'] = 'Rückmeldung bei richtiger Antwort';
$string['deletealluserdata'] = 'Alle Simple-Quiz-Versuche löschen';
$string['deletequestion'] = 'Diese Frage löschen';
$string['discardactivequestion'] = 'Nicht gespeicherte Änderungen an der aktuellen Frage verwerfen?';
$string['discardquestion'] = 'Änderungen verwerfen';
...
$string['incorrectfeedback'] = 'Rückmeldung bei falscher Antwort';
...
$string['partiallycorrectfeedback'] = 'Rückmeldung bei teilweise richtiger Antwort';
$string['pluginadministration'] = 'Simple-Quiz-Administration';
$string['pluginname'] = 'Simple Quiz';
$string['plugintitle'] = 'Simple Quiz';
$string['previewanswers'] = 'Antworten';
$string['previewcorrect'] = 'Richtig';
$string['previewfeedback'] = 'Rückmeldung';
$string['previewincorrect'] = 'Falsch';
$string['previewpartial'] = 'Teilweise richtig';
$string['privacy:metadata:core_files'] = 'Die Simple-Quiz-Aktivität speichert Dateien, die in der Aktivitätseinführung und im Frageninhalt eingebettet sind.';
$string['privacy:metadata:simplequiz2_attempt_data'] = 'Antwortdaten pro Sitzung, während der Benutzer die Aktivität durchläuft.';
$string['privacy:metadata:simplequiz2_attempt_data:answers'] = 'JSON-kodierte Zuordnung von Fragenkennungen zu Antwortergebnissen für diese Sitzung.';
$string['privacy:metadata:simplequiz2_attempt_data:cmid'] = 'Die Kursmodulinstanz, zu der diese Sitzung gehört.';
$string['privacy:metadata:simplequiz2_attempt_data:timecreated'] = 'Zeitpunkt der Erstellung dieses Sitzungsdatensatzes.';
$string['privacy:metadata:simplequiz2_attempt_data:userid'] = 'Der Benutzer, zu dem diese Sitzung gehört.';
$string['privacy:metadata:simplequiz2_attempts'] = 'Zusammenfassung der Versuche jedes Benutzers für eine bestimmte Simple-Quiz-Aktivitätsinstanz.';
$string['privacy:metadata:simplequiz2_attempts:cmid'] = 'Die Kursmodulinstanz, zu der diese Zusammenfassung gehört.';
$string['privacy:metadata:simplequiz2_attempts:cntattempt'] = 'Anzahl der für diesen Benutzer erfassten Versuche.';
$string['privacy:metadata:simplequiz2_attempts:completed'] = 'Ob der Benutzer die Aktivität erfolgreich abgeschlossen hat (pluginspezifisches Kennzeichen).';
$string['privacy:metadata:simplequiz2_attempts:timefirstattempt'] = 'Zeitpunkt des ersten Versuchs.';
$string['privacy:metadata:simplequiz2_attempts:timelastattempt'] = 'Zeitpunkt des letzten Versuchs.';
$string['privacy:metadata:simplequiz2_attempts:userid'] = 'Der Benutzer, zu dem diese Zusammenfassung gehört.';
...
$string['restart'] = 'Quiz wiederholen';
...
$string['savequestion'] = 'Änderungen speichern';
