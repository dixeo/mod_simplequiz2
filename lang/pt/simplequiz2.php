...
$string['correctfeedback'] = 'Feedback quando a resposta está correta';
$string['deletealluserdata'] = 'Eliminar todas as tentativas do QCM';
$string['deletequestion'] = 'Eliminar esta pergunta';
$string['discardactivequestion'] = 'Descartar as alterações não guardadas da pergunta atual?';
$string['discardquestion'] = 'Descartar alterações';
...
$string['incorrectfeedback'] = 'Feedback quando a resposta está incorreta';
...
$string['partiallycorrectfeedback'] = 'Feedback quando a resposta está parcialmente correta';
$string['pluginadministration'] = 'Administração do QCM';
$string['pluginname'] = 'QCM';
$string['plugintitle'] = 'QCM';
$string['previewanswers'] = 'Respostas';
$string['previewcorrect'] = 'Correta';
$string['previewfeedback'] = 'Feedback';
$string['previewincorrect'] = 'Incorreta';
$string['previewpartial'] = 'Parcialmente correta';
$string['privacy:metadata:core_files'] = 'A atividade QCM armazena ficheiros incorporados na introdução da atividade e no conteúdo das perguntas.';
$string['privacy:metadata:simplequiz2_attempt_data'] = 'Dados de respostas por sessão enquanto o utilizador progride na atividade.';
$string['privacy:metadata:simplequiz2_attempt_data:answers'] = 'Mapa JSON de identificadores de perguntas para resultados de respostas nesta sessão.';
$string['privacy:metadata:simplequiz2_attempt_data:cmid'] = 'A instância do módulo da disciplina a que esta sessão pertence.';
$string['privacy:metadata:simplequiz2_attempt_data:timecreated'] = 'Quando este registo de sessão foi criado.';
$string['privacy:metadata:simplequiz2_attempt_data:userid'] = 'O utilizador a quem esta sessão pertence.';
$string['privacy:metadata:simplequiz2_attempts'] = 'Resumo de cada tentativa do utilizador para uma instância de atividade QCM.';
$string['privacy:metadata:simplequiz2_attempts:cmid'] = 'A instância do módulo da disciplina a que este resumo pertence.';
$string['privacy:metadata:simplequiz2_attempts:cntattempt'] = 'Quantas tentativas foram registadas para este utilizador.';
$string['privacy:metadata:simplequiz2_attempts:completed'] = 'Se o utilizador concluiu a atividade com sucesso (indicador específico do plugin).';
$string['privacy:metadata:simplequiz2_attempts:timefirstattempt'] = 'Data da primeira tentativa.';
$string['privacy:metadata:simplequiz2_attempts:timelastattempt'] = 'Data da tentativa mais recente.';
$string['privacy:metadata:simplequiz2_attempts:userid'] = 'O utilizador a quem este resumo pertence.';
...
$string['restart'] = 'Refazer questionário';
...
$string['savequestion'] = 'Guardar alterações';
