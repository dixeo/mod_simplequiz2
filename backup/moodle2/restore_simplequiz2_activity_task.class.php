...
require_once($CFG->dirroot . '/mod/simplequiz2/backup/moodle2/restore_simplequiz2_stepslib.php');

/**
 * simplequiz restore task that provides all the settings and steps to perform one
...
class restore_simplequiz2_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_simplequiz2_activity_structure_step('simplequiz2_structure', 'simplequiz2.xml'));
    }
